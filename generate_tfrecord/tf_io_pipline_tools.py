...
def write_example_tfrecords(gt_images_paths, gt_binary_images_paths, tfrecords_path):
    """
    write tfrecords
...
def augment_for_train(gt_image, gt_binary_image):
    ...
    gt_image, gt_binary_image = random_color_augmentation(
...
def normalize(gt_image, gt_binary_image):
    """
...
def random_crop_batch_images(gt_image, flipped_gt_binary_image, cropped_size):
    """
    ...
    :return:
    """
    concat_images = tf.concat([gt_image, gt_binary_image], axis=-1)
...
def random_horizon_flip_batch_images(gt_image, gt_binary_image):
    """
...
def random_color_augmentation(gt_image, gt_binary_image):
    """
